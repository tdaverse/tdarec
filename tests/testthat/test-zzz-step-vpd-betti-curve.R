...
test_that("`step_vpd_betti_curve()` agrees with raw function", {
...
test_that("`tunable()` returns standard names", {
  ...
  vpd_rec <- dist_rec |> 
    step_vpd_betti_curve(dist_pd, keep_original_cols = FALSE)
