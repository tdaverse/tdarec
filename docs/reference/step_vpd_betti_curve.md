...
The function `step_vpd_betti_curve()` creates a *specification* of a
recipe step that will convert a list-column of 3-column matrices of
...
[`TDAvec::computeBettiCurve()`](https://rdrr.io/pkg/TDAvec/man/computeBettiCurve.html).
...
#> # A tibble: 1 × 100
#>   image  image_bc_1 image_bc_2 image_bc_3 image_bc_4 image_bc_5 image_bc_6
#>   <list>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>
#> 1 <PHom>          0          0          0          0          0          0
#> # ℹ 93 more variables: image_bc_7 <dbl>, image_bc_8 <dbl>, image_bc_9 <dbl>,
#> #   image_bc_10 <dbl>, image_bc_11 <dbl>, image_bc_12 <dbl>, image_bc_13 <dbl>,
#> #   image_bc_14 <dbl>, image_bc_15 <dbl>, image_bc_16 <dbl>, image_bc_17 <dbl>,
#> #   image_bc_18 <dbl>, image_bc_19 <dbl>, image_bc_20 <dbl>, image_bc_21 <dbl>,
#> #   image_bc_22 <dbl>, image_bc_23 <dbl>, image_bc_24 <dbl>, image_bc_25 <dbl>,
#> #   image_bc_26 <dbl>, image_bc_27 <dbl>, image_bc_28 <dbl>, image_bc_29 <dbl>,
#> #   image_bc_30 <dbl>, image_bc_31 <dbl>, image_bc_32 <dbl>, …
...
#>   terms   value id                   
#>   <chr>   <dbl> <chr>                
#> 1 chem_fp    NA vpd_betti_curve_dRDOf
