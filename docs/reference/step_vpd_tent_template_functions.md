...
The function `step_vpd_tent_template_functions()` creates a
...
- tent_size:
  ...
  The length of the increment used to discretize tent template
  functions.
...
- `tent_size`: Discretization grid increment (type: double, default:
  `NULL`)

- `num_bins`: Discretization grid bins (type: integer, default: `10L`)

- `tent_shift`: Discretization grid shift (type: double, default:
  `NULL`)
...
#> • tent template functions of: image
print(volc_rec)
#> 
#> ── Recipe ──────────────────────────────────────────────────────────────────────
#> 
...
#> # A tibble: 1 × 111
#>   image  image_tf_1 image_tf_2 image_tf_3 image_tf_4 image_tf_5 image_tf_6
#>   <list>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>
#> 1 <PHom>          0          0          0          0          0          0
#> # ℹ 104 more variables: image_tf_7 <dbl>, image_tf_8 <dbl>, image_tf_9 <dbl>,
#> #   image_tf_10 <dbl>, image_tf_11 <dbl>, image_tf_12 <dbl>, image_tf_13 <dbl>,
#> #   image_tf_14 <dbl>, image_tf_15 <dbl>, image_tf_16 <dbl>, image_tf_17 <dbl>,
#> #   image_tf_18 <dbl>, image_tf_19 <dbl>, image_tf_20 <dbl>, image_tf_21 <dbl>,
#> #   image_tf_22 <dbl>, image_tf_23 <dbl>, image_tf_24 <dbl>, image_tf_25 <dbl>,
#> #   image_tf_26 <dbl>, image_tf_27 <dbl>, image_tf_28 <dbl>, image_tf_29 <dbl>,
#> #   image_tf_30 <dbl>, image_tf_31 <dbl>, image_tf_32 <dbl>, …
...
#> • tent template functions of: chem_fp
...
#>   terms   value id                               
#>   <chr>   <dbl> <chr>                            
#> 1 chem_fp    NA vpd_tent_template_functions_jouUT
