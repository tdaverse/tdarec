...
The function `step_vpd_persistent_entropy_summary()` creates a
...
[`TDAvec::computePersistentEntropy()`](https://rdrr.io/pkg/TDAvec/man/computePersistentEntropy.html).
...
#> • persistent entropy summary of: image
print(volc_rec)
#> 
#> ── Recipe ──────────────────────────────────────────────────────────────────────
#> 
...
#> # A tibble: 1 × 100
#>   image  image_pe_1 image_pe_2 image_pe_3 image_pe_4 image_pe_5 image_pe_6
#>   <list>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>
#> 1 <PHom>          0          0          0          0          0          0
#> # ℹ 93 more variables: image_pe_7 <dbl>, image_pe_8 <dbl>, image_pe_9 <dbl>,
#> #   image_pe_10 <dbl>, image_pe_11 <dbl>, image_pe_12 <dbl>, image_pe_13 <dbl>,
#> #   image_pe_14 <dbl>, image_pe_15 <dbl>, image_pe_16 <dbl>, image_pe_17 <dbl>,
#> #   image_pe_18 <dbl>, image_pe_19 <dbl>, image_pe_20 <dbl>, image_pe_21 <dbl>,
#> #   image_pe_22 <dbl>, image_pe_23 <dbl>, image_pe_24 <dbl>, image_pe_25 <dbl>,
#> #   image_pe_26 <dbl>, image_pe_27 <dbl>, image_pe_28 <dbl>, image_pe_29 <dbl>,
#> #   image_pe_30 <dbl>, image_pe_31 <dbl>, image_pe_32 <dbl>, …
...
#> • persistent entropy summary of: chem_fp
...
#> 2      2 step      vpd_persistent_entropy_summary FALSE   FALSE vpd_persistent_…
#> 3      3 step      pca                            FALSE   FALSE pca_Oqm81       
tidy(perm_rec, number = 2)
#> # A tibble: 1 × 3
#>   terms   value id                                  
#>   <chr>   <dbl> <chr>                               
#> 1 chem_fp    NA vpd_persistent_entropy_summary_IeZBD
