...
The function `step_vpd_persistence_landscape()` creates a
...
- num_levels:
  ...
  The number of levels of a persistence landscape to vectorize. If
  `num_levels` is greater than the length of a landscape, then
  additional levels of zeros will be included.
...
- weight_func_pl:
  ...
  A *single* character for the type of kernel function used to compute
...
- `weight_func_pl`: Kernel distance weight function (type: character,
  default: `"triangle"`)
...
#> • persistence landscape of: image
print(volc_rec)
#> 
#> ── Recipe ──────────────────────────────────────────────────────────────────────
#> 
...
#> # A tibble: 1 × 301
#>   image  image_pl_1_1 image_pl_1_2 image_pl_1_3 image_pl_1_4 image_pl_1_5
#>   <list>        <dbl>        <dbl>        <dbl>        <dbl>        <dbl>
#> 1 <PHom>            0            0            0            0            0
#> # ℹ 295 more variables: image_pl_1_6 <dbl>, image_pl_1_7 <dbl>,
#> #   image_pl_1_8 <dbl>, image_pl_1_9 <dbl>, image_pl_1_10 <dbl>,
#> #   image_pl_1_11 <dbl>, image_pl_1_12 <dbl>, image_pl_1_13 <dbl>,
#> #   image_pl_1_14 <dbl>, image_pl_1_15 <dbl>, image_pl_1_16 <dbl>,
#> #   image_pl_1_17 <dbl>, image_pl_1_18 <dbl>, image_pl_1_19 <dbl>,
#> #   image_pl_1_20 <dbl>, image_pl_1_21 <dbl>, image_pl_1_22 <dbl>,
#> #   image_pl_1_23 <dbl>, image_pl_1_24 <dbl>, image_pl_1_25 <dbl>, …
...
#> • persistence landscape of: chem_fp
...
#> 1      1 step      pd_point_cloud            FALSE   FALSE pd_point_cloud_oDqZE 
#> 2      2 step      vpd_persistence_landscape FALSE   FALSE vpd_persistence_land…
#> 3      3 step      pca                       FALSE   FALSE pca_272kp            
tidy(perm_rec, number = 2)
#> # A tibble: 1 × 3
#>   terms   value id                             
#>   <chr>   <dbl> <chr>                          
#> 1 chem_fp    NA vpd_persistence_landscape_lIhdo
