...
The function `step_vpd_algebraic_functions()` creates a *specification*
...
[`TDAvec::computeAlgebraicFunctions()`](https://rdrr.io/pkg/TDAvec/man/computeAlgebraicFunctions.html).
...
#> # A tibble: 1 × 5
#>   image           image_af_f1 image_af_f2 image_af_f3 image_af_f4
#>   <list>                <dbl>       <dbl>       <dbl>       <dbl>
#> 1 <PHom [18 × 3]>        104.        2.72     390745.       0.226
...
#> • algebraic functions of: chem_fp
...
#>   terms   value id                           
#>   <chr>   <dbl> <chr>                        
#> 1 chem_fp    NA vpd_algebraic_functions_wuFPL
