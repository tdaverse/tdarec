...
The function `step_vpd_normalized_life_curve()` creates a
...
[`TDAvec::computeNormalizedLife()`](https://rdrr.io/pkg/TDAvec/man/computeNormalizedLife.html).
...
#> • normalized life curve of: image
print(volc_rec)
#> 
#> ── Recipe ──────────────────────────────────────────────────────────────────────
#> 
...
#> # A tibble: 1 × 100
#>   image  image_nl_1 image_nl_2 image_nl_3 image_nl_4 image_nl_5 image_nl_6
#>   <list>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>      <dbl>
#> 1 <PHom>          0          0          0          0          0          0
#> # ℹ 93 more variables: image_nl_7 <dbl>, image_nl_8 <dbl>, image_nl_9 <dbl>,
#> #   image_nl_10 <dbl>, image_nl_11 <dbl>, image_nl_12 <dbl>, image_nl_13 <dbl>,
#> #   image_nl_14 <dbl>, image_nl_15 <dbl>, image_nl_16 <dbl>, image_nl_17 <dbl>,
#> #   image_nl_18 <dbl>, image_nl_19 <dbl>, image_nl_20 <dbl>, image_nl_21 <dbl>,
#> #   image_nl_22 <dbl>, image_nl_23 <dbl>, image_nl_24 <dbl>, image_nl_25 <dbl>,
#> #   image_nl_26 <dbl>, image_nl_27 <dbl>, image_nl_28 <dbl>, image_nl_29 <dbl>,
#> #   image_nl_30 <dbl>, image_nl_31 <dbl>, image_nl_32 <dbl>, …
...
#> • normalized life curve of: chem_fp
...
#> 1      1 step      pd_point_cloud            FALSE   FALSE pd_point_cloud_2KndA 
#> 2      2 step      vpd_normalized_life_curve FALSE   FALSE vpd_normalized_life_…
#> 3      3 step      pca                       FALSE   FALSE pca_FWRrU            
tidy(perm_rec, number = 2)
#> # A tibble: 1 × 3
#>   terms   value id                             
#>   <chr>   <dbl> <chr>                          
#> 1 chem_fp    NA vpd_normalized_life_curve_lDfG6
