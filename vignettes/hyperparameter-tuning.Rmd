...
We specify 3 initial seeds with 6 tuning iterations each, and we limit the total runtime to 5 minutes.
(This vignette is for illustration, and these choices keep its time cost manageable; additional iterations and seeds may prove necessary in practice.)
