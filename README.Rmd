...
This project was funded by [an ISC grant from the R Consortium](https://r-consortium.org/all-projects/2024-group-1.html#modular-interoperable-and-extensible-topological-data-analysis-in-r) and done in coordination with [Aymeric Stamm](@astamm) and with guidance from [Bertrand Michel](@bertrandmichel) and [Paul Rosen](@PaulRosenPhD).
It builds upon the work of and conversations with [Umar Islambekov](@uislambekov) and [Aleksei Luchinsky](@ALuchinsky), authors of [{TDAvec}](https://github.com/uislambekov/TDAvec).
