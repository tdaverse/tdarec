...
#' 
#' @description The function `step_vpd_pl()` creates
...
#' @example inst/examples/zzz-step-vpd-pl.R

#' @export
step_vpd_pl <- function(
    recipe,
    ...,
    role = "predictor",
    trained = FALSE,
  ...
  recipes_pkg_check(required_pkgs.step_vpd_pl())
...
#' @export
prep.step_vpd_pl <- function(x, training, info = NULL, ...) {
...
#' @export
bake.step_vpd_pl <- function(object, new_data, ...) {
...
#' @export
required_pkgs.step_vpd_pl <- function(x, ...) {
  c("TDAvec", "tdarec")
}
